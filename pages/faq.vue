...
const faqs = [
  {
    ...
    answer:
      'All bootcamps are available in a live-remote format with select cohorts will be offered both in-person and live-remote. Programming 101 and 102 will continue to be live-remote online classes.',
  },
  {
    id: 2,
