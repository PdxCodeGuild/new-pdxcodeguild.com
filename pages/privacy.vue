<template>
  <main class="px-2 sm:px-12 text-gray-800">
    ...
    <h1 class="text-2xl py-6">Interpretation and Definitions</h1>
    <h2 class="text-xl py-4">Interpretation</h2>
    <p>
      The words of which the initial letter is capitalized have meanings defined
      under the following conditions. The following definitions shall have the
      same meaning regardless of whether they appear in singular or in plural.
    </p>
    <h2 class="text-xl py-4">Definitions</h2>
    ...
    <ul class="list-disc list-inside">
      ...
      <li>
        <p>
          ...
          this Agreement) refers to PDX Code Guild, 407 NE 12th Avenue Portland,
          OR 97232.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to PDX Code Guild, accessible from
          <a
            class="text-orange"
            href="https://pdxcodeguild.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://pdxcodeguild.com</a
          >
        </p>
      </li>
      <li>
    ...
    <h1 class="text-2xl py-6">Collecting and Using Your Personal Data</h1>
    <h2 class="text-xl py-4">Types of Data Collected</h2>
    <h3 class="text-lg py-3">Personal Data</h3>
    <p>
    ...
    <h3 class="text-lg py-3">Usage Data</h3>
    ...
    <h3 class="text-lg py-3">Tracking Technologies and Cookies</h3>
    <p>
    ...
    <h2 class="text-xl py-4">Use of Your Personal Data</h2>
    ...
    <h2 class="text-xl py-4">Retention of Your Personal Data</h2>
    <p>
    ...
    <h2 class="text-xl py-4">Transfer of Your Personal Data</h2>
    <p>
    ...
    <h2 class="text-xl py-4">Disclosure of Your Personal Data</h2>
    <h3 class="text-lg py-3">Business Transactions</h3>
    <p>
    ...
    <h3 class="text-lg py-3">Law enforcement</h3>
    <p>
    ...
    <h3 class="text-lg py-3">Other legal requirements</h3>
    <p>
    ...
    <h2 class="text-xl py-4">Security of Your Personal Data</h2>
    <p>
    ...
    <h1 class="text-2xl py-6">Children's Privacy</h1>
    <p>
    ...
    <h1 class="text-2xl py-6">Links to Other Websites</h1>
    <p>
    ...
    <h1 class="text-2xl py-6">Changes to this Privacy Policy</h1>
    <p>
    ...
    <h1 class="text-2xl py-6">Contact Us</h1>
    <p>
      If you have any questions about this Privacy Policy, You can contact us:
    </p>
    <ul class="list-disc list-inside">
      <li>By email: admin@pdxcodeguild.com</li>
    </ul>
  </main>
</template>
